...
Task folder: /home/erin/hermes_data/subagents/active/20260403-142521-hide-host-models-when-stopped
...
Goal:
- Update dashboard to not show 'Host Models' unless server is running
...
- Ensure the work is committed on task/hide-host-models-when-stopped before cleanup.

Starting point:
- Base branch in main checkout: tui
- Task branch: task/hide-host-models-when-stopped
