...
class JobManager:
    ...
    # TODO Make state diagram for this function        
    def get_model_for_pipe(self, model_id: str, pipe: MetaPipe, device: str, available_memory: int) -> Tuple[int, Optional[LlmModel]]:
        ...
        num_layers_to_load = int(available_memory // computed.avg_layer_size) - 1 # minus 1 because we include the current index
    ...
    def host_model(self, model_id: str, max_memory: int, device: str):
