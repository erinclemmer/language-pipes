...
class LanguagePipes:
    ...
    def __init__(
        ...
        self.job_receiver = JobReceiver(self.config.processor, self.router.node, self.job_manager.get_pipe, self.job_manager.get_end_model, self.job_manager.restart_job)
