TIPS = {
    "network": {
        "configure": {
            ...
            "whitelist_node_ids": "A list of nodes that this node is allowed to communicate\nwith. Keep the list empty to allow all nodes\nthat pass authentication to communicate."
        }
    }
}